...
<f:view locale="#{localeHandler.locale}">
    <body class="red ct-navbar--fixedTop cssAnimate ct-js-navbarMakeSmaller ct-js-enableWayPoints" nav="requirements">
        <%-- Styles --%>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-9 col-md-push-3">
                            ...
                            <section class="ct-u-paddingBottom80">
                                <h:outputText escape="false" value="#{rbManualRequirements.p1}" />
                            </section>
