...
<f:view locale="#{localeHandler.locale}">
    <body class="red ct-navbar--fixedTop cssAnimate ct-js-navbarMakeSmaller ct-js-enableWayPoints" nav="edit-client">
        <%-- Styles --%>
        ...
        <div class="ct-pageWrapper" id="ct-js-wrapper">
            ...
            <jsp:include page="/WEB-INF/templates/page_header.jsp">
                ...
                <jsp:param name="content" value="${rbManual.edit_client}" />
                        ...
                        <div class="col-md-9 col-md-push-3">
                            ...
                            <section class="ct-u-paddingBottom40">
                                <div class="manual-image right">
                                    <h:outputLink value="/AbleChat/resources/images/manual/#{localeHandler.locale}/edit_client_dashboard.png" target="_blank">
                                        <h:graphicImage value="/resources/images/manual/#{localeHandler.locale}/edit_client_dashboard.png" />
                                    </h:outputLink>
                                </div>
                                <h:outputFormat escape="false" value="#{rbManualClients.edit_client_p1}">
                                    <f:param value="#{rbDashboard.edit_client}" />
                                </h:outputFormat>
                                <div class="clearfix"></div>
                            </section>
                            <section class="ct-u-paddingBottom80">
                                <div class="manual-image right">
                                    <h:outputLink value="/AbleChat/resources/images/manual/#{localeHandler.locale}/edit_client.png" target="_blank">
                                        <h:graphicImage value="/resources/images/manual/#{localeHandler.locale}/edit_client.png" />
                                    </h:outputLink>
                                </div>
                                ...
                                <h:outputFormat escape="false" value="#{rbManualClients.edit_client_p2}">
                                    <f:param value="#{rbClientEdit.save}" />
                                </h:outputFormat>
                                <div class="clearfix"></div>
                            </section>
