    ...
    <body class="blue ct-navbar--fixedTop cssAnimate ct-js-enableWayPoints">
        ...
        <div class="ct-pageWrapper" id="ct-js-wrapper">
            ...
            <jsp:include page="/WEB-INF/templates/plain_page_header.jsp">
                <jsp:param name="heading" value="${rbLanding.welcome}" />
            </jsp:include>
            ...
            <section class="ct-u-paddingTop20 ct-u-paddingBottom100 ct-u-diagonalTopLeft ct-u-diagonalBottomRight" data-height="100%">
                <div class="container">
                    ...
                    <div class="row">
                        <div class="col-sm-2 col-md-2 ct-u-marginBottom70"></div>
                            ...
                            <div class="ct-iconBox ct-iconBox--default">
                                ...
                                <div class="ct-iconBox-content">
                                    <h4 class="ct-iconBox-title text-lowercase ct-fw-600">
                                        <h:outputText value=" #{rbLanding.create_account}" />
                                    </h4>
                                    <p>
                                        <h:outputText value=" #{rbLanding.create_account_subtext}" />
                                    </p>

                                    <h:outputLink value="#{navigateTo.register.register}" styleClass="btn ct-btn--perspective btn-primary btn-lg">
                        ...
                        <div class="col-sm-4 col-md-4 ct-u-marginBottom70">
                            <div class="ct-iconBox ct-iconBox--default">
                                ...
                                <div class="ct-iconBox-content">
                                    <h4 class="ct-iconBox-title text-lowercase ct-fw-600">
                                        <h:outputText value=" #{rbLanding.login}" />
                                    </h4>
                                    <p>
                                        <h:outputText value=" #{rbLanding.login_subtext}" />
                                    </p>

                                    <h:outputLink value="#{navigateTo.login.login}" styleClass="btn ct-btn--perspective btn-primary btn-lg">
