...
<f:view locale="#{localeHandler.locale}">
    <body class="red ct-navbar--fixedTop cssAnimate ct-js-navbarMakeSmaller ct-js-enableWayPoints" nav="change-layout">
        <%-- Styles --%>
                ...
                <div class="container">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-9 col-md-push-3">
                            ...
                            <section class="ct-u-paddingBottom40">
                                <div class="manual-image right">
                                    <h:outputLink value="/AbleChat/resources/images/manual/#{localeHandler.locale}/edit_page_admin.png" target="_blank">
                                        <h:graphicImage value="/resources/images/manual/#{localeHandler.locale}/edit_page_admin.png" />
                                    </h:outputLink>
                                </div>
                                <h:outputFormat escape="false" value="#{rbManualPages.edit_page_p2}">
                                    <f:param value="#{rbPageDetail.edit_page}" />
                                </h:outputFormat>
                                <div class="clearfix"></div>
                            </section>
                            <section class="ct-u-paddingBottom80">
                                <div class="manual-image right">
                                    <h:outputLink value="/AbleChat/resources/images/manual/#{localeHandler.locale}/edit_page.png" target="_blank">
                                        <h:graphicImage value="/resources/images/manual/#{localeHandler.locale}/edit_page.png" />
                                    </h:outputLink>
                                </div>
                                <h:outputText escape="false" value="#{rbManualPages.edit_page_p3}" />
                                <div class="clearfix"></div>
                            </section>
