...
<f:view locale="#{localeHandler.locale}">
    <body class="red ct-navbar--fixedTop cssAnimate ct-js-navbarMakeSmaller ct-js-enableWayPoints" nav="register-account">
        <%-- Styles --%>
        ...
        <div class="ct-pageWrapper" id="ct-js-wrapper">
            ...
            <jsp:include page="/WEB-INF/templates/page_header.jsp">
                ...
                <jsp:param name="content" value="${rbManual.register_account}" />
                        ...
                        <div class="col-md-9 col-md-push-3">
                            ...
                            <section class="ct-u-paddingBottom40">
                                <div class="manual-image right">
                                    <h:outputLink value="/AbleChat/resources/images/manual/#{localeHandler.locale}/landing.png" target="_blank">
                                        <h:graphicImage value="/resources/images/manual/#{localeHandler.locale}/landing.png" />
                                    </h:outputLink>
                                </div>
                                <h:outputFormat escape="false" value="#{rbManualRegister.p1}">
                                    <f:param value="#{rbMenu.register}" />
                                    <f:param value="#{rbMenu.register}" />
                                </h:outputFormat>
                            ...
                            <section class="ct-u-paddingBottom40">
                                <div class="manual-image right">
                                    <h:outputLink value="/AbleChat/resources/images/manual/#{localeHandler.locale}/register.png" target="_blank">
                                        <h:graphicImage value="/resources/images/manual/#{localeHandler.locale}/register.png" />
                                    </h:outputLink>
                                </div>
                                <h:outputText escape="false" value="#{rbManualRegister.p2}" />
                                <div class="clearfix"></div>
                            </section>
                            <section class="ct-u-paddingBottom40">
                                <div class="manual-image right">
                                ...
                                <h:outputFormat escape="false" value="#{rbManualRegister.p3}">
                            ...
                            <section class="ct-u-paddingBottom40">
                                <h:outputText escape="false" value="#{rbManualRegister.p4}" />
                                <div class="clearfix"></div>
                            </section>
