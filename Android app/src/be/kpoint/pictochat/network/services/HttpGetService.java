...
public class HttpGetService extends IntentService 
{
	...
	protected void onHandleIntent(Intent intent)
	{
		...
		{			
			...
			if (intent.hasExtra(IntentSettings.Mandatory.EXTRA_URL)) {
				String requestUrl = (String)intent.getExtras().get(IntentSettings.Mandatory.EXTRA_URL);
				processSingleRequest(intent, requestUrl, httpClient);
			} 
	...
	private void processSingleRequest(Intent intent, String requestUrl, DefaultHttpClient httpClient) {
